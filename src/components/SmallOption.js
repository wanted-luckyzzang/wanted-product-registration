  ...
  return (
    <Grid border='#ececec' radius='0.3rem' column margin='1rem 0 0 0'>
      <Grid isFlex justify='flex-end' padding='0 1rem 0 0'>
        <Button border='#dc2b2c' width='3.3rem' height='2rem' type='button' _onClick={optionDelete} margin='1rem 0 1rem 0'>
          <Text color='#dc2b2c'>삭제</Text>
        </Button>
      </Grid>

      <Grid padding='0 1rem 0 1rem'>
        <Input placeholder='   옵션명을 입력해 주세요.(필수)' height='2.5rem' width='100%' margin='0 0 1rem 0' />
      </Grid>

      <Grid isFlex align='center' padding='0 1rem 0 1rem' margin='0 0 1rem 0'>
        <Input placeholder='상품 정상가 (필수)' height='2.5rem' width='10rem' margin='0 1rem 0 0' textAlign='center' />
        ...
        <Input placeholder='상품 판매가 (필수)' height='2.5rem' width='10rem' margin='0 1rem 0 1rem' textAlign='center' />
        <Text margin='0 1rem 0 0'>원</Text>
        <Input placeholder='재고 (필수)' height='2.5rem' width='10rem' margin='0 1rem 0 1rem' textAlign='center' />
      ...
      {option.map((el, idx) => (
        <Grid isFlex key={el.key} padding='0 1rem 0 2rem' align='center'>
          ...
          <Input placeholder='추가 옵션명 (필수)' height='2.5rem' width='22rem' margin='0 1rem 0 1rem' textAlign='center' />
          <Input placeholder='추가 옵션 정상가 (필수)' height='2.5rem' width='16rem' margin='0 1rem 0 1rem' textAlign='center' />
          <Text margin='0 1rem 0 0' size='1rem'>
            원
          </Text>
          <Button
