...
const NoticeInfo = () => {
  return (
    <>
      <Grid marginTop='2rem' width='auto' bg='#d3d3d36b' height='35rem' column isFlex align='center'>
        <Main>
          <Header>
          ...
          <div>
            ...
            <InfoOptions>
              ...
              <Input placeholder='내용을 입력해주세요.' width='27.8rem' textIndent='1rem' margin='0 1rem 0 0' />
              <button
                style={{
                  border: '1px solid #e3e3e3',
                  width: '6rem',
