...
const NoticeInfo = () => {
<<<<<<< HEAD:src/components/NoticeInfo.js
  return (
    <>
      <Grid bg='#d3d3d36b' height='35rem' column isFlex align='center'>
        <Main>
          ...
          <div>
            ...
            <InfoOptions>
              <Input placeholder='항목 제목 자유 입력' width='17rem' textIndent='1rem' />
              <Input placeholder='내용을 입력해주세요.' width='27.8rem' textIndent='1rem' />
              <button
                style={{
                  border: '1px solid #e3e3e3',
                  width: '6rem',
            ...
            <Button width='10rem' bg='transparent' color='#352f6e' border='1px solid #ebebeb' bold='700'>
              + 항목 추가
            </Button>
          </div>
        </Main>
        <Footer>
          <Button width='100%' bg='transparent' color='#352f6e' border='1.5px solid #352f6e' fontWeight='bold'>
            + 정보고시 추가
          </Button>
        </Footer>
      </Grid>
...
>>>>>>> main:src/components/ProductNoticeInfo/NoticeInfo.js
};
